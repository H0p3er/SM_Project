...
(76, 'Asus Gaming Desktop', 1, 0, 800, 20000000, 'NULL', 'Gaming desktop by Asus with Intel Core i5-11400F CPU, NVIDIA GeForce GTX 1650 GPU, 16GB DDR4 RAM, and 512GB SSD storage.', '2023-11-15', CURDATE(), 6, 3, 22), 
(77, 'Giga Gaming Desktop', 1, 0, 1000, 35000000, 'NULL', 'Gaming desktop by Giga with Intel Core i7-14700K CPU, NVIDIA GeForce RTX 4060 Ti GPU, 32GB DDR5 RAM, and 1TB SSD + 2TB HDD storage.', '2023-10-05', CURDATE(), 6, 1, 18), 
(78, 'MSI Gaming Desktop', 1, 0, 1200, 25000000, 'NULL', 'Gaming desktop by MSI with Intel Core i5-12600K CPU, NVIDIA GeForce RTX 4060 Ti GPU, 16GB DDR4 RAM, and 1TB SSD storage.', '2023-09-20', CURDATE(), 6, 4, 20), 
(79, 'Asus Gaming Desktop', 1, 0, 900, 23000000, 'NULL', 'Gaming desktop by Asus with AMD Ryzen 9 5900X CPU, NVIDIA GeForce RTX 3080 GPU, 64GB DDR4 RAM, and 2TB NVMe SSD + 4TB HDD storage.', '2023-08-10', CURDATE(), 6, 2, 25), 
(80, 'Giga Gaming Desktop', 1, 0, 600, 10000000, 'NULL', 'Gaming desktop by Giga with AMD Ryzen 7 5800X CPU, NVIDIA GeForce RTX 3070 Ti GPU, 32GB DDR4 RAM, and 1TB SSD storage.', '2023-12-01', CURDATE(), 6, 5, 15), 
(81, 'MSI Gaming Desktop', 1, 0, 800, 16000000, 'NULL', 'Gaming desktop by MSI with Intel Core i9-12900K CPU, NVIDIA GeForce RTX 3090 GPU, 64GB DDR5 RAM, and 2TB NVMe SSD storage.', '2023-07-25', CURDATE(), 6, 3, 22), 
(82, 'Asus Office Desktop', 1, 0, 1100, 30000000, 'NULL', 'Office desktop by Asus with Intel Core i7-12700K CPU, NVIDIA GeForce RTX 3050 GPU, 32GB DDR4 RAM, and 1TB SSD storage.', '2023-06-15', CURDATE(), 6, 1, 20), 
(83, 'Giga Graphics Desktop', 1, 0, 1300, 35000000, 'NULL', 'Graphics desktop by Giga with AMD Ryzen 5 5600X CPU, NVIDIA GeForce RTX 3060 GPU, 16GB DDR4 RAM, and 512GB NVMe SSD storage.', '2023-05-05', CURDATE(), 6, 4, 18), 
(84, 'MSI Graphics Desktop', 1, 0, 1400, 38000000, 'NULL', 'Graphics desktop by MSI with Intel Core i5-12400F CPU, NVIDIA GeForce GTX 1660 Ti GPU, 16GB DDR4 RAM, and 512GB SSD + 1TB HDD storage.', '2023-04-10', CURDATE(), 6, 2, 21), 
(85, 'Asus Office Desktop', 1, 0, 950, 18000000, 'NULL', 'Office desktop by Asus with Intel Core i3-12100F CPU, NVIDIA GeForce GT 1030 GPU, 8GB DDR4 RAM, and 256GB SSD storage.', '2023-03-20', CURDATE(), 6, 5, 17),
