                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <ul class="ps-0" style="list-style-type: none;">
                                                                ...
                                                                %>
                                                                <li><span id="order-product-id"><%= bdDTO.getProduct_quantity() %>x</span><a href=""><%= bdDTO.getProduct().getName() %></a></li>
                                                                <%
                                                                    }
                                                                }
                                                                %>
                                                        ...
                                                        <td><div >
                                                            ...
                                                            out.println(formattedPrice);%></div>
                                                            <%
                                                            byte status = billDTO.getStatus();
                                                            if (status == 1) {
                                                            %>
                                                            <button class="btn btn-secondary" id="purchase">Thanh toán</button>
                                                            <% }%>
                                                        </td>
                                                        <td>
                                                            <%
                                                        ...
                                                        <td>
													        ...
													        %>
													        <form action="<%= request.getContextPath() %>/user/bills" method="post" onsubmit="return confirmCancel()">
