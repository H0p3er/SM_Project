                ...
                <% session=request.getSession(true); if (session.getAttribute("userLogined")!=null) { %>
                  <li><a class="bg-dark " data-bs-toggle="dropdown" aria-expanded="false"><i
                    ...
                    <ul class="dropdown-menu" id="dropdown">
                      ...
                      <li>
                        <a class="dropdown-item p-0 bg-white text-black" href="/home/user/bills"><i class="fa-solid fa-box me-1"></i> Đơn hàng</a>
                      </li>
                      <li> <!-- /home/main/user/shop_create.jsp -->
                        <a class="dropdown-item p-0 bg-white text-black"  href="/home/user/shop/profile"><i class="fa-solid fa-store"></i> Gian hàng của bạn</a>
                      </li>
