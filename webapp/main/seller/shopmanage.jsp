          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Đơn hàng <span>| Tháng</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Lượt khách <span>| Tháng</span></h5>
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  <h5 class="card-title">Đơn hàng mới <span>| Tuần</span></h5>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">2 tuần</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">1 tháng</div>
