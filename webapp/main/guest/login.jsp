						...
						<div class="row">
							<div class="col-lg-12">
								<fieldset>
									<label for="name">Tên đăng nhập</label> <input type="text"
										name="txtname" id="txtname" placeholder="Username"
							...
							<div class="col-lg-12">
								<fieldset>
									<label for="email">Mật khẩu</label> <input type="password"
										name="txtpass" id="txtpass" placeholder="Password" required>
								</fieldset>
							</div>
							<div class="row align-items-center">
								...
								<div class="col-lg-7 mt-3 mt-lg-0">
									Chưa có tài khoản? <a href="/home/main/guest/register.jsp">Đăng
										ký</a>
								</div>
							</div>
						</div>
