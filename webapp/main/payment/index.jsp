...
<html lang="en">
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "/home/main/payment/vnpay_pay.jsp";
            }
            function querydr() {
              window.location.href = "/home/main/payment/vnpay_querydr.jsp";
            }
             function refund() {
              window.location.href = "/home/main/payment/vnpay_refund.jsp";
            }
        </script>
    </body>
</html>
