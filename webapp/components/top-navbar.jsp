    ...
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="/home/backend/index.html" class="header-logo">
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
										...
										<div class="px-3 pt-0 pb-0 sub-card">
                                                ...
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                            src="/home/images/user/01.jpg" alt="01">
                                                    </div>
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                            src="/home/images/user/02.jpg" alt="02">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                            src="/home/images/user/03.jpg" alt="03">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="/home/images/user/1.jpg" class="img-fluid rounded-circle" alt="user">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right border-none" aria-labelledby="dropdownMenuButton">
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="/home/app/user-profile.html">Trang cá nhân</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="/home/app/user-profile-edit.html">Chỉnh sửa Trang cá nhân</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="/home/app/user-account-setting.html">Cài đặt tài khoản</a>
                                </li>
                                <li class="dropdown-item d-flex svg-icon">
                                    ...
                                    <a href="/home/app/user-privacy-setting.html">Cài đặt quyền riêng tư</a>
                                </li>
