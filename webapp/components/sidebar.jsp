...
<div class="iq-sidebar sidebar-default">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-around">
        <a href="/home/index.jsp" class="header-logo nav-link">
            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="">
                    <a href="/home/index.jsp" class="svg-icon nav-link">                        
                        <i class="ri-home-8-line nav-item-icons"></i>
                ...
                <li class="navbar-item">
                    <a class="nav-link" href="/home/workplace/list" class="svg-icon">                        
                        <i class="las la-table nav-item-icons"></i><span class="ml-2">Vị trí/phòng</span>
                    </a>
                </li>
                <li class="navbar-item">
                    <a href="#transaction" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">                        
                ...
                <li class="navbar-item">
                    <a href="#partner" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">                        
                    ...
                    <ul id="partner" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
	                        <a href="/home/user/user-list.jsp">
                ...
                <li class="navbar-item">
                    <a href="#employee" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">                        
                        <i class="las la-handshake nav-item-icons"></i>
                    ...
                    <ul id="employee" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                    	<li class="navbar-item">
		                    <a href="#employee-detail" class="collapsed svg-icon" data-toggle="collapse" aria-expanded="false">                        
		                    ...
		                    <ul id="employee-detail" class="iq-submenu collapse" data-parent="#employee-detail">
	                            <li class="navbar-item">
		                            <a href="/home/employee/employee-list.jsp">
                ...
                <li class="navbar-item">
                    <a href="/home/backend/index.html" class="svg-icon">                        
