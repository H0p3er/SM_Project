...
//		
		...
		tmp.append("</div>");
		tmp.append("<div class=\"card-body\">");
		tmp.append("<textarea id=\"txtProductDesc"+item.getProduct_id()+"\" class=\"form-control\" height=\"60\" name=\"txtProductDesc\">"+utility.Utilities.decode(item.getProduct_desc())+"</textarea>");
		tmp.append("</div>");// card-body
		tmp.append("</div>"); // card
		...
		tmp.append("</div>");
		tmp.append("<div class=\"card-body\">");
		tmp.append("<textarea class=\"form-control\" height=\"60\" value=\"\" name=\"txtProductNote\">"+utility.Utilities.decode(item.getProduct_notes())+"</textarea>");
		tmp.append("</div>");
		tmp.append("</div>"); // card
