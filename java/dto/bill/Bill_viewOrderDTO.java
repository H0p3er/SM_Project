...
public class Bill_viewOrderDTO implements Bill_DTO{
	...
	private List<BD_viewOrderDTO> bd;
	...
	public List<BD_viewOrderDTO> getBd() {
		return bd;
	}


	public void setBd(List<BD_viewOrderDTO> bd) {
		this.bd = bd;
	}
